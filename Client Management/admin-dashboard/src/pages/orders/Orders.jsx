...
const Orders = () => {
    ...
    const { isLoading, clients } = useSelector((state) => state.admin);
	...
	const handleOrderSubmit = async (e) => {
        e.preventDefault();
        if(!input.client || !input.projectName || !input.clientCompany || input.works.length === 0 || !input.employeeWorks.length === 0 || !input.status || !input.month || !input.freelancerName || !input.freelancerCompany || !input.freelancerCountry){
