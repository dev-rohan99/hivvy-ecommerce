...
import { addNewEmployee, deleteEmployee, getAllEmployee, updateEmployee } from '../controllers/employeeController.js';
...
// employee router
router.post('/add-new-employee', adminMiddleware, addNewEmployee);
router.get('/all-employee', adminMiddleware, getAllEmployee);
router.patch('/employees/:id', adminMiddleware, updateEmployee);
router.delete('/employees/:id', adminMiddleware, deleteEmployee);
