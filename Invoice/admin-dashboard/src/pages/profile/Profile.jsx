...
import useAuthHook from '../../hooks/useAdminHook';
							...
							<div className="profile-header">
								<div className="row align-items-center">
									<div className="col-md-2 col-auto profile-image">
										<a href="#">
											<img className="rounded-circle" alt="admin Image" src={admin?.avatar ? admin?.avatar : "https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg"}/>
										</a>
									</div>
									<div className="col ml-md-n2 profile-admin-info">
										<h4 className="admin-name mb-0">{admin?.name ? admin?.name : "Anounmus"}</h4>
										<h6 className="text-muted">{admin?.email ? admin?.email : ""}</h6>
										<div className="admin-Location">{admin?.address ? admin?.addresses : ""}</div>
									</div>
										...
										<div className="col-lg-12">
											<div className="card">
												<div className="card-body">
													...
													{admin?.name && <div className="row">
														<p className="col-sm-2 text-muted text-sm-left mb-0 mb-sm-3">Name</p>
														<p className="col-sm-10">{admin?.name}</p>
													</div>}
													{(admin?.birthDate & admin?.birthMonth & admin?.birthYear) ? <div className="row">
