...
const OrderDatatable = () => {
    ...
    const { isLoading, orders, clients, invoice, employees } = useSelector((state) => state.admin);
                                            ...
                                            <div ref={printRef} className="px-5">
                                                <div className="row mt-4">
                                                    <div className="col-12 col-lg-12">
                                                        {invoice?.clientCompany && <><div className="row">
                                                                    ...
                                                                    <tbody className="text-95 text-secondary-d3">
...

                                                                        {
                                                                            invoice?.works.map((data, index) => <tr key={index}>
                                                                                ...
                                                                                <td className="text-secondary-d2">${(data.hours * data.hourlyRate).toFixed(2)}</td>
                                                                            </tr>)
                                                                        }

                                                                        <tr>
                                                                            <td className="textInc">Total</td>
                                                                            <td className="textInc"></td>
                                                                            <td className="textInc">{invoice?.totalHours.toFixed(2)}</td>
                                                                            <td className="text-95 textInc"></td>
                                                                            <td className="text-secondary-d2 textInc">${invoice?.subTotal.toFixed(2)}</td>
                                                                        </tr> 
                                                            ...
                                                            <div className="row mt-3">
                                                                ...
                                                                <div className="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                                                    <div className="row my-2">
                                                                        ...
                                                                        <div className="col-4">
                                                                            <span className="text-120 text-secondary-d1">${invoice?.subTotal.toFixed(2)}</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="row my-2">
                                                                        ...
                                                                        <div className="col-4">
                                                                            <span className="text-110 text-secondary-d1">-${invoice?.adjustments.toFixed(2)}</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="row my-2 align-items-center bgc-primary-l3 p-2">
                                                                        ...
                                                                        <div className="col-4">
                                                                            <span className="text-150 text-success-d3 opacity-2 font-bold">${invoice?.totalAmount.toFixed(2)}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <tbody className="text-95 text-secondary-d3">
...

                                                                        {
                                                                            invoice?.employeeWorks.map((data, index) => <tr key={index}>
                                                                                <td>{employees.find(employee => data.name == employee._id)?.name}</td>
                                                                                <td>{data.hoursBreakdown.toFixed(2)}</td>
                                                                                <td className="text-95">{data.hoursAdjustment.toFixed(2)}</td>
                                                                            </tr>)
                                                                        }

                                                                        <tr>
                                                                            <td className="textInc">Total Hours</td>
                                                                            <td className="textInc">{invoice?.employeeWorks.reduce((acc, work) => acc + work.hoursBreakdown, 0).toFixed(2)}</td>
                                                                            <td className="text-secondary-d2 textInc">{invoice?.employeeWorks.reduce((acc, work) => acc + work.hoursAdjustment, 0).toFixed(2)}</td>
                                                                        </tr> 
                                            ...
                                            <div className="row form-row">
                                                ...
                                                <div className="col-12">
                                                    ...
                                                    <div className="form-group p-1">
                                                        ...
                                                        <input name="issueDate" type="date" value={input.issueDate} onChange={handleInputChange} className="form-control" />
                                                    </div>
